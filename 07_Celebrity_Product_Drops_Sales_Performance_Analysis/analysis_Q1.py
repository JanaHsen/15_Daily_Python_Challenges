...
# Identify records with missing sale_amount
missing_amount = q1_2025[q1_2025['sale_amount'].isna()]

# Display results
print("Celebrity Collaboration Records with Missing Sale Amount (Q1 2025)")
print("="*60)
print(missing_amount[['sale_id', 'sale_date', 'product_id', 'celebrity_id']].to_string(index=False))