...
# Filter for groups with more than 50 participants
more_october_participants = october_groups[october_groups['participant_count']>50]

#Calculate the average number of messages
average_messages = more_october_participants['total_messages'].mean()
print('The average number of messages sent for Whatsapp groups who have greater than 50 participants is ' , average_messages)