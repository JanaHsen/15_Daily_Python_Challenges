...
# Display first and last five entries of cleaned data
print("First 5 Entries of Cleaned Dataset:")
print("="*50)
print(df.head().to_string())

print("\nLast 5 Entries of Cleaned Dataset:")
print("="*50)
print(df.tail().to_string())

# Additional summary statistics by category
print("\nRating Statistics by Category:")
print("="*50)
category_stats = df.groupby('category')['rating'].agg(['count', 'mean', 'min', 'max'])
